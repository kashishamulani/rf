...
<div style="padding:10px; width:100%;">
    ...
    <div style="display:flex; justify-content:center; width:100%;">
        <form action="{{ route('team-members.update', $member->id) }}" method="POST" class="team-form">
            @csrf
            @method('PUT')
            ...
            <div style="margin-bottom:20px;">
                ...
                <input type="text" name="name" value="{{ old('name', $member->name) }}" placeholder="Enter full name"
                    required minlength="2" maxlength="255" pattern="[A-Za-z\s\.]+"
                    title="Name can contain only letters and spaces"
                    oninput="this.value=this.value.replace(/[^A-Za-z\s\.]/g,'')" class="form-input">
            </div>
            ...
            <div style="margin-bottom:20px;">
                ...
                <input type="text" name="designation" value="{{ old('designation', $member->designation) }}"
                    placeholder="Enter designation" required minlength="2" maxlength="255" class="form-input">
            </div>
            ...
            <div style="margin-bottom:20px;">
                ...
                <input type="email" name="email" value="{{ old('email', $member->email) }}"
                    placeholder="example@email.com" required maxlength="255" class="form-input">
            </div>
            ...
            <div style="margin-bottom:20px;">
                ...
                <input type="tel" name="mobile" value="{{ old('mobile', $member->mobile) }}"
...
{{-- ✅ SAME STYLE AS CREATE PAGE + SIDEBAR RESPONSIVE --}}
<style>
.team-form {
    width: 100%;
    max-width: 800px;
...
/* when sidebar closed -> form becomes wider */
body.sidebar-closed .team-form {
    max-width: 1100px;
}
