...
.remark-wrapper:hover .remark-tooltip {
    visibility: visible;
    opacity: 1;
}
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td
                                ...
                                <a href="{{ route('assignment.students.fullview', [$assignment->id, $c->id]) }}"
                                    class="eye-btn">
                            ...
                            <td style="max-width:180px; position:relative;">

                                @if(!empty($c->remark))

                                <div class="remark-wrapper">
                                    <span class="remark-text">
                                        {{ \Illuminate\Support\Str::limit($c->remark, 25, '...') }}
                                    </span>
