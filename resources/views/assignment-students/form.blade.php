...
@endif
            ...
            <div class="grid" style="margin-bottom:12px; grid-template-columns: repeat(2, 1fr);">
                ...
                <div class="field">
                    ...
                    <textarea name="remark" class="f-input" maxlength="50" style="height:34px;"
                        oninput="updateCharCount(this)">{{ old('remark', $data->remark ?? '') }}</textarea>
    ...
    <option value="0"
        {{ old('offer_letter_done', $data->offer_letter_done ?? 0) == 0 ? 'selected' : '' }}>
        No
    </option>

    <option value="1"
        {{ old('offer_letter_done', $data->offer_letter_done ?? 0) == 1 ? 'selected' : '' }}>
        Yes
    </option>
</select>
                </div>
                ...
                <div class="field">
                    <label>User ID</label>
                    <input type="text" name="registration_id" class="f-input" value="{{ old('registration_number', $data->registration_number ?? '') }}">
                </div>
    ...
    <option value="0"
        {{ old('documents_done', $data->documents_done ?? 0) == 0 ? 'selected' : '' }}>
        No
    </option>

    <option value="1"
        {{ old('documents_done', $data->documents_done ?? 0) == 1 ? 'selected' : '' }}>
        Yes
    </option>
</select>
                </div>
